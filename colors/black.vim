...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#ffffff', '#ca1243', '#2a871f', '#c18401',
        \ '#2f6aea', '#a626a4', '#0184bc', '#000000', '#808080', '#ca1243',
  ...
  " hi VertSplit guifg=#000000 guibg=#ff00ff gui=NONE cterm=NONE
  hi VertSplit guifg=#000000 guibg=#0f0f0f gui=NONE cterm=NONE
  hi Pmenu guifg=NONE guibg=#000000 gui=NONE cterm=NONE
  hi PmenuSel guifg=#0f0f0f guibg=#000000 gui=NONE cterm=NONE
  ...
  hi pythonFunction guifg=#ffffff guibg=NONE gui=NONE cterm=NONE
