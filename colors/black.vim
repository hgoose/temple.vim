...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#9e9ea0', '#ca1243', '#2a871f', '#c18401',
        \ '#2f6aea', '#a626a4', '#0184bc', '#9e9ea0', '#808080', '#ca1243',
        \ '#2a871f', '#c18401', '#2f6aea', '#a626a4', '#0184bc', '#ffffff']
  if has('nvim')
    let g:terminal_color_0 = '#9e9ea0'
  ...
  if get(g:, 'black_transp_bg', 0) && !has('gui_running')
    hi Normal guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#9e9ea0 guibg=#000000 gui=NONE cterm=NONE
  endif
  hi EndOfBuffer guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi Statusline guifg=#9e9ea0 guibg=NONE gui=bold cterm=bold
  hi StatuslineNC guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi StatuslineTerm guifg=#9e9ea0 guibg=NONE gui=bold cterm=bold
  hi StatuslineTermNC guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  " hi VertSplit guifg=#9e9ea0 guibg=#ff00ff gui=NONE cterm=NONE
  hi VertSplit guifg=#9e9ea0 guibg=#0f0f0f gui=NONE cterm=NONE
  hi Pmenu guifg=NONE guibg=#9e9ea0 gui=NONE cterm=NONE
  hi PmenuSel guifg=#0f0f0f guibg=#9e9ea0 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#9e9ea0 gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#9e9ea0 gui=NONE cterm=NONE
  ...
  hi NonText guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi SpecialKey guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  ...
  hi LineNr guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  ...
  hi SignColumn guifg=#9e9ea0 guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Sign guifg=#9e9ea0 guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Underlined guifg=#2f6aea guibg=NONE gui=underline cterm=underline
  hi Error guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi ModeMsg guifg=#9e9ea0 guibg=NONE gui=bold cterm=bold
  ...
  hi Todo guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi Search guifg=#9e9ea0 guibg=#32344a gui=NONE cterm=NONE
  hi IncSearch guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi Cursor guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi lCursor guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Identifier guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  ...
  hi pythonFunction guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi method guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Tag guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi Delimiter guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
  hi Type guifg=#ff0000 guibg=NONE gui=NONE cterm=NONE
  hi Directory guifg=#9e9ea0 guibg=NONE gui=bold cterm=bold
  hi Comment guifg=#808080 guibg=NONE gui=NONE cterm=NONE
  hi Conceal guifg=#9e9ea0 guibg=NONE gui=NONE cterm=NONE
