...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if get(g:, 'li_transp_bg', 0) && !has('gui_running')
  ...
  hi Pmenu guifg=#ffffff guibg=#232a36 gui=NONE cterm=NONE
  ...
  hi Statement guifg=#128912 guibg=NONE gui=NONE cterm=NONE
  hi Constant guifg=#ff0000 guibg=NONE gui=NONE cterm=NONE
  " hi String guifg=#00DB2B guibg=NONE gui=NONE cterm=NONE
  hi String guifg=#428282 guibg=NONE gui=NONE cterm=NONE
  hi pythonFunction guifg=#1f1fff guibg=NONE gui=NONE cterm=NONE
  hi method guifg=#000000 guibg=NONE gui=NONE cterm=NONE
  " hi FunctionCall guifg=#FFCB6B guibg=NONE gui=NONE cterm=NONE
  hi Function guifg=#ff00ff guibg=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#128912 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Comment guifg=#1f1fff guibg=NONE gui=NONE cterm=NONE
