...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#ffffff', '#ca1243', '#2a871f', '#c18401',
        \ '#2f6aea', '#a626a4', '#0184bc', '#282a36', '#808080', '#ca1243',
  ...
  " hi VertSplit guifg=#282a36 guibg=#ff00ff gui=NONE cterm=NONE
  hi VertSplit guifg=#282a36 guibg=#0f0f0f gui=NONE cterm=NONE
  hi Pmenu guifg=NONE guibg=#282a36 gui=NONE cterm=NONE
  hi PmenuSel guifg=#0f0f0f guibg=#282a36 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#282a36 gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#282a36 gui=NONE cterm=NONE
  ...
  hi NonText guifg=#282a36 guibg=NONE gui=NONE cterm=NONE
  ...
  hi String guifg=#dfdf85 guibg=NONE gui=NONE cterm=NONE
