...
let g:airline#themes#black#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#black#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#black#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
...
let g:airline#themes#black#palette.normal.airline_warning = s:WARNING
let g:airline#themes#black#palette.insert.airline_warning = s:WARNING
let g:airline#themes#black#palette.visual.airline_warning = s:WARNING
let g:airline#themes#black#palette.replace.airline_warning = s:WARNING

let g:airline#themes#black#palette.normal.airline_error = s:ERROR
let g:airline#themes#black#palette.insert.airline_error = s:ERROR
let g:airline#themes#black#palette.visual.airline_error = s:ERROR
let g:airline#themes#black#palette.replace.airline_error = s:ERROR
...
let g:airline#themes#black#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)
