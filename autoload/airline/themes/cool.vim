...
let g:airline#themes#cool#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)

" Warning info
let s:WARNING = [ s:guiBlack, s:gui03, s:ctermBlack, s:cterm03 ]
let s:ERROR = [ s:guiWhite, s:gui05, s:ctermWhite, s:cterm05 ]

let g:airline#themes#cool#palette.normal.airline_warning = s:WARNING
let g:airline#themes#cool#palette.insert.airline_warning = s:WARNING
let g:airline#themes#cool#palette.visual.airline_warning = s:WARNING
let g:airline#themes#cool#palette.replace.airline_warning = s:WARNING

let g:airline#themes#cool#palette.normal.airline_error = s:ERROR
let g:airline#themes#cool#palette.insert.airline_error = s:ERROR
let g:airline#themes#cool#palette.visual.airline_error = s:ERROR
let g:airline#themes#cool#palette.replace.airline_error = s:ERROR
...
let g:airline#themes#cool#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)
